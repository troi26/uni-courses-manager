...
import { Grid, Table, Segment, Card, Button, Dimmer, Loader, Input, Dropdown, List, Checkbox, TextArea, Label, SegmentInline, Modal, Header, Icon, Message } from "semantic-ui-react";
...
export const Course = () => {
    ...
    const saveCourseChanges = async () => {
        try {
            ...
            setPeriodSuccessMessage("Course`s changes have been saved successfully");
        } catch (err) {
            console.error(err);
        }
